...
public class LengthTest {
    ...
    public void should_2_feet_equals_2_feet() {
        Length result = new Length(2, Length.FOOT).as(Unit.FOOT);
    ...
    public void should_1_yard_equals_1_yard() {
        Length result = new Length(1, Length.YARD).as(Unit.YARD);
    ...
    public void should_1_foot_equals_12_inches() {
        Length result = new Length(1, Length.FOOT).as(Unit.INCH);
    ...
    public void should_3_foot_equals_1_yard() {
        Length result = new Length(3, Length.FOOT).as(Unit.YARD);
    ...
    public void should_1_yard_equals_3_feet() {
        Length result = new Length(1, Length.YARD).as(Unit.FOOT);
